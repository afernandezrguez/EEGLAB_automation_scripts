...
%         EEG = pop_epoch( EEG, {  'StimulusBegin'  }, [-0.2         0.8], 'newname', 'Imported BCI2000 data set epochs', 'epochinfo', 'yes');
        EEG = pop_epoch( EEG, {  'StimulusBegin'  }, [-1         2], 'newname', 'Imported BCI2000 data set epochs', 'epochinfo', 'yes');
        ...
        [ALLEEG EEG CURRENTSET] = pop_newset(ALLEEG, EEG, 3,'savenew',[char(newFileName) '_attend'],'gui','off'); 
        ...
        [ALLEEG EEG CURRENTSET] = pop_newset(ALLEEG, EEG, 3,'savenew',[char(newFileName) '_ignore'],'gui','off'); 
